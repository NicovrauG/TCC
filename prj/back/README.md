# Neste diretório estão os arquivos:
 ...
 - `emg_code` — Script responsável por escutar os dados que chegam no Broker MQTT, processar/filtrar os dados e gerar tanto um CSV dos dados quanto um relatório do sinal plotado em PDF.
